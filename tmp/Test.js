                        ...
                        if (_30.length > 0) {
                            ...
                            return (function (_67) {
                                if (_67.ctor === "Prelude.EQ") {
                                    return compare(ordArray(__dict_Ord_9))(_71)(_69);
                                };
                                return _67;
...
PS.Data_Eq = (function () {
    ...
    var liftRef = function (_33) {
        return function (_34) {
            return function (_35) {
                return _33(_34.values[0])(_35.values[0]);
            };
        };
    };
...
PS.Test_Chai = (function () {
    ...
    var Prelude = PS.Prelude;
    var Expect = {
        ctor: "Test.Chai.Expect", 
        values: [  ]
    };
    var Error = {
        ctor: "Test.Chai.Error", 
        values: [  ]
    };
...
var PS = PS || {};
PS.Control_Reactive_Timer_Spec = (function () {
    "use strict";
    var Prelude = PS.Prelude;
    ...
    var spec = Test_Mocha.describe("Timer")(function __do() {
        Test_Mocha.itAsync("timeout should resolve")(function (done) {
            return Control_Reactive_Timer.timeout(5)(function (_) {
                return Prelude["return"](Control_Monad_Eff.monadEff({}))(Test_Mocha.itIs(done));
            });
        })();
        Test_Mocha.itAsync("clearTimeout cancels the timer")(function (done) {
            return function __do() {
                var _5 = Control_Monad_ST.newSTRef(false)();
                var _4 = Control_Reactive_Timer.timeout(5)(function (_) {
                    return Control_Monad_ST.modifySTRef(_5)(function (_) {
                        return true;
                    });
                })();
                Control_Reactive_Timer.clearTimeout(_4)();
                return Control_Reactive_Timer.timeout(10)(function (_) {
                    return function __do() {
                        var _3 = Control_Monad_ST.readSTRef(_5)();
                        Test_Chai.toEqual(Test_Chai.expect(_3))(false)();
                        return Test_Mocha.itIs(done);
                    };
                })();
            };
        })();
        Test_Mocha.itAsync("interval should resolve")(function (done) {
            return function __do() {
                var _8 = Control_Monad_ST.newSTRef(0)();
                var _7 = Control_Reactive_Timer.interval(10)(function (_) {
                    return Control_Monad_ST.modifySTRef(_8)(function (n) {
                        return n + 1;
                    });
                })();
                return Control_Reactive_Timer.timeout(10 * (7 + 1))(function (_) {
                    return function __do() {
                        var _6 = Control_Monad_ST.readSTRef(_8)();
                        Test_Chai.toBeAtLeast(Test_Chai.expect(_6))(7)();
                        Control_Reactive_Timer.clearInterval(_7)();
                        return Test_Mocha.itIs(done);
                    };
                })();
            };
        })();
        return Test_Mocha.itAsync("clearInterval cancels the timer")(function (done) {
            return function __do() {
                var _11 = Control_Monad_ST.newSTRef(false)();
                var _10 = Control_Reactive_Timer.interval(5)(function (_) {
                    return Control_Monad_ST.modifySTRef(_11)(function (_) {
                        return true;
                    });
                })();
                Control_Reactive_Timer.clearInterval(_10)();
                return Control_Reactive_Timer.timeout(10)(function (_) {
                    return function __do() {
                        var _9 = Control_Monad_ST.readSTRef(_11)();
                        Test_Chai.toEqual(Test_Chai.expect(_9))(false)();
                        return Test_Mocha.itIs(done);
                    };
                })();
            };
...
PS.Main = (function () {
    "use strict";
    var Control_Reactive_Timer_Spec = PS.Control_Reactive_Timer_Spec;
    var main = Control_Reactive_Timer_Spec.spec;
    return {
        main: main
    };
})();
